...
def renomear_questoes_simples():
    ...
    for i in range(7, 11+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
        antigo = f"parte_{i:03d}.png"
        novo = f"questao-{i-6}-espanhol.png"  # faça uma conta: se a primeira pagina for 
        #novo = f"questao-{i-6}-ingles.png"
        #novo = f"questao-{i+75}.png" # faça uma conta: se o i do teu for está em 2, e precisa virar questão 35, como você transforma 2 em 35? faça a conta e coloque dentro da concatenação
