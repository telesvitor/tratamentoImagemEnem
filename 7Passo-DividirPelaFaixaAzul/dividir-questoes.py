...
if __name__ == "__main__":
    ...
    #caminho_imagem = "./recortadas/pagina_enem_15.png"  # Substitua pelo caminho da sua imagem
    #caminho_imagem = "./recortadas/pagina_enem_28.png"  # Substitua pelo caminho da sua imagem
